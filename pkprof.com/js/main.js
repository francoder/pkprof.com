...
---------------------------------
  ...
  22. jQuery slideDown categories menu list
...
/* isotop active */
    ...
    ------------------------*/
    var disqus_config;
    $('#disqus [data-toggle="tab"]').on('click', function () {
        var tab_id = $(this).data('id');
        $('#'+tab_id+'.disqus-container').trigger('loadDisqus');
    });
...
---------------------------- */
    ...
    $('#categories').click(function(){
        if ($('.category-menu-list').is(':hidden')) {
